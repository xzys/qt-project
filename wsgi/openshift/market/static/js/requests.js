		...
		if (categoryType == 'A') {
			...
			'<div class="panel panel-default">',
				...
				'<div style="float:left;  width:70%;;overflow:hidden; overflow: hidden">',
					...
					'<span style="float: left; font-weight:300">' + fields.item.fields.seller.fields.username + '</span>' + '<span style="float: right; font-weight:100">ISBN: ' + fields.isbn + '</span></h4>',
				'</div>',
			...
			'<div class="panel panel-default">',
				...
				'<div style="float:left;  width:70%;;overflow:hidden; overflow: hidden">',
					'<h2>' + fields.event + '</h2>',
					'<h4 style="font-weight:500">' + fields.date.split('T')[0].replace('-', '/').replace('-', '/') + '<span style="float: right; font-weight:300">' + fields.item.fields.seller.fields.username + '@cornell.edu</span></h4>',
				'</div>',
				'<div style="text-align: right; font-size: 3.2em; font-weight:100; float:right; width:30%; ;overflow:hidden; height: 100px">$' + parseInt(fields.item.fields.price) + '</div>',
			'<br></div></div></div>',
			].join('\n');
